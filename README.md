...
В таблицах Log и LogDetails будет записана информация о результатах работы. Если возникла ошибка, то в целях отладки можно получить текст всего сгенерированного скрипта импорта данных:
```
call integrations.usp_runIntegration(1, in_verbose => 2);
```

## Авторы
- https://github.com/Nisetie